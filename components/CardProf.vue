<template>
  <div class=" py-6  mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl ">
    <div class="grid gap-8 lg:grid-cols-3 sm:max-w-sm sm:mx-auto lg:max-w-full">
      <div class="p-8 bg-white border rounded shadow-sm relative">
        <a href="/" aria-label="Article" title="Mathematiques" class="inline-block mb-3 text-2xl font-bold leading-5 text-black transition-colors duration-200 hover:text-deep-purple-accent-400">Mathematiques</a>
        <p class="mb-5 text-gray-700 text-justify">
        ...
        <div class="flex items-center">
          ...
          <div>
            ...
            <p class="text-sm font-medium leading-4 bg-green-500 shadow text-center rounded-md text-white">Disponible</p>
          </div>
        </div>
        ...
        <span  title="plus de details" class="bg-primary  cursor-pointer hover:opacity-75   right-4 bottom-4 absolute text-lg text-white rounded-full px-2 py-1 font-bold text-center ">+</span>
      </div>
      <div class="p-8 bg-white border rounded shadow-sm relative">
        <a href="/" aria-label="Article" title="Mathematiques" class="inline-block mb-3 text-2xl font-bold leading-5 text-black transition-colors duration-200 hover:text-deep-purple-accent-400">Mathematiques</a>
        <p class="mb-5 text-gray-700 text-justify">
      ...
      <div class="p-8 bg-white border rounded shadow-sm relative">
        ...
        <div class="flex items-center">
          ...
          <div>
            <a href="/" aria-label="Author" title="Author" class="font-semibold text-gray-800 transition-colors duration-200 hover:text-deep-purple-accent-400">Vasile Melinte</a>
            <p class="text-sm font-medium leading-4 bg-red-500 shadow text-center rounded-md text-white">occupé</p>
          </div>
        </div>
        <div class="flex items-center my-4 ">
          <svg class="mx-1 w-4 h-4 fill-current text-yellow-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M10 15l-5.878 3.09 1.123-6.545L.489 6.91l6.572-.955L10 0l2.939 5.955 6.572.955-4.756 4.635 1.123 6.545z"/></svg>
